"""
Django settings for lawngenie project.
...
ALLOWED_HOSTS = ['lawngenie.herokuapp.com', 'localhost']
...
# Copied from django-allauth documentation - django-allauth.readthedocs.io
...
if 'USE_AWS' in os.environ:
    ...
    # Bucket Config
    AWS_STORAGE_BUCKET_NAME = 'lawngenie'
...
if 'DEVELOPMENT' in os.environ:
    ...
    DEFAULT_FROM_EMAIL = 'team.lawngenie@gmail.com'
else:
